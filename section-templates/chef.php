...
<div class="section bg-white" data-aos="fade-up">
    <div class="container">
        ...
        <?php
            $meal_chefs = $meal_section_meta['chefs'];
        if($meal_chefs):
        ?>
        <div class="row">
            <?php foreach($meal_chefs as $meal_chef): 
                        ...
                        <div class="ftco-38-img">
                            ...
                            <div class="ftco-38-body">
                                ...
                                <?php if($meal_chef['social_profiles']['instagram']): ?>
                                    <a href="<?php echo esc_url($meal_chef['social_profiles']['instagram']); ?>" class="p-2"><span class="fa fa-instagram">    
                                    </span></a>
                                <?php endif; ?>    
                                </p>                            
                            </div>
