...
$meal_section_meta = get_post_meta($meal_section_id,'meal-section-featured',true);
            ...
            <div class="ftco-46">
                <div class="ftco-46-row d-flex flex-column flex-lg-row">
                    ...
                    <div class="ftco-46-text ftco-46-arrow-left">
                        ...
                        <p class="mb-5">
                            <?php 
                            echo esc_html($meal_recipe_two->post_excerpt);
                            ?>
                        </p>
                ...
                <div class="ftco-46-row d-flex flex-column flex-lg-row">
                    <div class="ftco-46-text ftco-46-arrow-right">
                        ...
                        <p class="mb-5">
                           <?php
                            echo esc_html($meal_recipe_one->post_excerpt);
                            ?>
                        </p>
                    ...
                    <div class="ftco-46-text ftco-46-arrow-up">
                        <h4 class="ftco-46-subheading">
                        <?php echo esc_html(get_recipe_category($meal_recipe_three->ID)); ?>
                        </h4>
                        <h3 class="ftco-46-heading"><?php echo esc_html($meal_recipe_three->post_title); ?></h3>
                        <p class="mb-5">
                            <?php 
                            echo esc_html($meal_recipe_three->post_excerpt); 
                            ?>
                        </p>
